...
class __TwigTemplate_e73067f467760e544540a7e5a4797aa050eb4007d3dbbb291368baa718ceecda extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div>
           Bonjour {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Déconnexiont</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "D:\\wamp64\\www\\symfony\\eolia-symfo-calendar\\templates\\security\\login.html.twig");
    }
}
